...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_client_login_with_qr_code(ptr: bigint, qr_code_data: bigint, oidc_configuration: Uint8Array, progress_listener: bigint): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_client_login_with_qr_code(): number;
...
export interface InitOutput {
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_login_with_qr_code: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: bigint) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_login_with_qr_code: (a: bigint, b: bigint, c: number, d: number, e: bigint) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_checksum_method_client_login_with_qr_code: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_client_login_with_qr_code: () => number;
  ...
  readonly closure657_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
  readonly __externref_table_dealloc: (a: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb21cb6b26d5293b6: (a: number, b: number) => void;
  readonly closure6036_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he9415369547e63a7: (a: number, b: number) => void;
  readonly closure8934_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h621cedabf18a6028: (a: number, b: number) => void;
