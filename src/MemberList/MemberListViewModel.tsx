...
// export function getPending3PidInvites(
// 	room: Room,
// 	searchQuery?: string,
// ): Member[] {
...
// 	const inviteEvents = room.currentState
// 		.getStateEvents("m.room.third_party_invite")
// 		.filter(function (e) {
// 			if (!isValid3pidInvite(e)) return false;
// 			if (
// 				searchQuery &&
// 				!(e.getContent().display_name as string)?.includes(searchQuery)
// 			)
// 				return false;
...
// 		(mxcAvatarURL &&
// 			mediaFromMxc(mxcAvatarURL).getThumbnailOfSourceHttp(96, 96, "crop")) ??
// 		undefined;
...
// 	const [memberMap, setMemberMap] = useState<Map<string, MemberWithSeparator>>(
// 		new Map(),
// 	);
...
// 						await sdkContext.memberListStore.loadMemberList(
// 							roomId,
// 							searchQuery,
// 						);
...
// 					if (
// 						joinedSdk.length > 0 &&
// 						(invitedSdk.length > 0 || threePidInvited.length > 0)
// 					)
...
// 					setMemberCount(
// 						joinedSdk.length + invitedSdk.length + threePidInvited.length,
// 					);
// 					if (!searchQuery) {
// 						/**
...
// 	const isPresenceEnabled = false;

// 	// Determines whether the rendered invite button is enabled or disabled
// 	const getCanUserInviteToThisRoom = useCallback(
// 		(): boolean => !!room && canInviteTo(room),
// 		[room],
// 	);
// 	const [canInvite, setCanInvite] = useState<boolean>(
// 		getCanUserInviteToThisRoom(),
// 	);
...
// 		[room],
// 	);
// 	const [shouldShowInvite, setShouldShowInvite] = useState<boolean>(
// 		getShouldShowInvite(),
// 	);
