...
export const BUSY_PRESENCE_NAME = new UnstableValue(
	"busy",
		...
		case "online":
			return (
				<OnlineOrUnavailableIcon
					height="8px"
					width="8px"
					className="mx_PresenceIconView_online"
				/>
			);
		case "offline":
			return (
				<OfflineIcon
					height="8px"
					width="8px"
					className="mx_PresenceIconView_offline"
				/>
			);
		case "unavailable":
		case "io.element.unreachable":
			return (
				<OnlineOrUnavailableIcon
					height="8px"
					width="8px"
					className="mx_PresenceIconView_unavailable"
				/>
			);
		case BUSY_PRESENCE_NAME.name:
		case BUSY_PRESENCE_NAME.altName:
			return (
				<DNDIcon height="8px" width="8px" className="mx_PresenceIconView_dnd" />
			);
		default:
...
const AvatarPresenceIconView: React.FC<Props> = ({
	className,
	presenceState,
}) => {
